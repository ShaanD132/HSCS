            ...
            <Section delay = {0.1}>
                <Container maxW = "container.lg">
                    <Box mt = {20}>
                        ...
                        <Box mt = {{base: 8, sm: 16}} px = {{base: 0, md: 8}}>
                            <Heading as = "h2" variant = "sub-title" fontWeight = "normal" color = {textColor} fontFamily = "Outfit" fontSize = {{base: 26, sm: 36, md: 40}}>
                                Memory and Storage
                            </Heading>
                            <Box mt = {8} px = {{base: 0, md: 10}}>
                                <Heading as = "h3" fontWeight = "normal" color = {textColor} fontFamily = "Zacbel X" fontSize = {{base: 22, sm: 30, md: 35}}>
